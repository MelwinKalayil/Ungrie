      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-stone-900">Ungrie</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#features" className="text-stone-500 hover:text-stone-900 text-sm transition-colors">
                  Features
                </a>
              </li>
              <li>
                <a href="#pricing" className="text-stone-500 hover:text-stone-900 text-sm transition-colors">
                  Pricing
                </a>
              </li>
              <li>
                <a href="#" className="text-stone-500 hover:text-stone-900 text-sm transition-colors">
                  Case Studies
                </a>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-stone-200 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              href="#"
              className="w-9 h-9 bg-stone-100 rounded-lg flex items-center justify-center hover:bg-primary/20 hover:text-orange-600 text-stone-500 transition-all"
            >
